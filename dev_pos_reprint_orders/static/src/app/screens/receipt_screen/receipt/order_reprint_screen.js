...
import { OrderReprintReceipt } from "@dev_pos_reprint_orders/app/screens/receipt_screen/receipt/order_reprint_receipt";

export class OrderReprintScreen extends Component {
    static components = { OrderReprintReceipt };
    static template = "dev_pos_reprint_orders.OrderReprintScreen";
