...
class AccountGeneralLedgerReport(models.AbstractModel):
    ...
    #     res = super(AccountGeneralLedgerReport, self)._do_query(options_list, expanded_account, fetch_lines)
    #     query, params = self._get_query_sums(options_list, expanded_account=expanded_account)
    #     self._cr.execute(query, params)
    #     for red in self._cr.dictfetchall():
    #         analytic_account = '['+red.get('analytic_account_code', '')+']'+ ' - ' + red.get('analytic_account')
    #         # rec.append(analytic_account)
    #         print(':;;;:::SSS::::::::::;;;;',analytic_account)
    #         print(":SSSSSSSSS:::::::::::;;;",res)
    #     # for rec in res:
    #     return res
    ...
    def _get_general_ledger_lines(self, options, line_id=None):
        ...
        # print(":SAAAAAAA::::::::::::::::::",accounts_results)
        ...
        for account, periods_results in accounts_results:
            ...
            lines.append(self._get_account_title_line(options, account, amount_currency, debit, credit, balance, has_lines, analytic_account_name))
            ...
            if has_lines and (unfold_all or is_unfolded):
                ...
                for aml in amls:
                    ...
                    lines.append(self._get_aml_line(options, account, aml, company_currency.round(cumulated_balance), analytic_account_name))
    ...
    @api.model
    def _get_account_title_line(self, options, account, amount_currency, debit, credit, balance, has_lines, analytic_account_name):
