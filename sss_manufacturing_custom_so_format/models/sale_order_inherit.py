...
class SaleOrderInherit(models.Model):
    ...
    manufacturing_count = fields.Integer(string='Manufacturing', compute="_compute_manufacturing_count")
    manufacturing_ids = fields.Many2many('mrp.production','manufacturing_order_type','saleorder_id','mrpproduction_id', string='Manufacturing Orders')
